    ...
    namespace anipal
    {
        namespace Eye
        {
            public class SRanipal_AvatarEyeSample_v2 : MonoBehaviour
            {
                ...
                /// <summary>
                /// Customize this number to indicate which subject is being recorded
                /// </summary>
                ...
                private const string EyesPath = "Assets/Data/Weights/eye_blendshapes.csv";
                ...
                private void FixedUpdate()
                {
                    ...
                    if (NeededToGetData)
                    {
                        ...
                        //Enable multiple expression tracking
                        ...
                        /*
                        record eyes blendshapes values for AUs with Enter (left arrow for previous and right arrow for next AU)
                        */
                        if (RecordingTimer.isRecording)
                        {
                            WriteEyeBlendshapes(EyeWeightings);
                            ++FrameCounter;
                        }
                ...
                /// <summary>
                /// write eyes blendshape values into the corresponding .csv file
                /// </summary>
                /// <param name="eyeWeightings"></param>
                /// <returns>void</returns>
                private void WriteEyeBlendshapes(Dictionary<EyeShape_v2, float> eyeWeightings){
                    ...
                    foreach (var weights in EyeWeightings)
                    {
                    ...
                    File.AppendAllText(EyesPath, csv.ToString());
                }
